...
class CommentSerializer(serializers.ModelSerializer):
    '''
        ...
        article 필드에 대해서 재정의하겠다.
            id랑 title을 보여주고 싶다!
            1. id랑 title만 보여주는 serializer를 따로 정의하기
                -> 무엇만을 위한 serializer인가
            2. 이미 있는 serializer 사용하기
    '''
