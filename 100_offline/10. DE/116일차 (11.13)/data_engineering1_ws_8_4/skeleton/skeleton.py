...
def main():
    ...
    # 반복 연산 적용
    processed_stream = process_transactions(transaction_stream)  # 반복 적용할 데이터 스트림 지정

    # 최종 결과 스트림 병합
    final_stream = processed_stream.union(high_value_stream, low_value_stream)  # 두 개의 데이터 스트림을 병합
